...
Step-by-step mathematical derivation with detailed explanations of variance-of-a-sum, monthly/daily TE ratios, and worked examples.

**→ [Technical Math: AR(1) & Newey-West](technical_math.html)**  
Advanced topics including closed-form AR(1) solutions, Newey-West estimation, and implementation code.
