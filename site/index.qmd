...
print(f"Random walk (φ=0):            {ratio_random:.4f}  → Monthly TE ≈ daily (±sampling noise)")
...
- **Random walk** (blue): Cumulative return meanders without strong trend. Monthly TE ≈ daily TE × √21 (up to sampling noise).
