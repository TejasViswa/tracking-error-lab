...
- **consistent (Newey–West) annualization** from daily data.

👉 **Interactive App:** <https://tracking-error-lab-kgkju98o4pqxdjoevqtsay.streamlit.app/>  
👉 **GitHub Repo:** <https://github.com/TejasViswa/tracking-error-lab>
...
The **sample Tracking Error** at the data’s native frequency is
$$
...
Therefore, the **$m$-period TE** (e.g., “monthly TE” from daily data with a fixed month length $m$) is
$$
...
# 5. Estimating Annualized TE Consistently (Newey–West)
...
- If you report **annualized TE from daily data**, prefer the **Newey–West** consistent estimator when autocorrelation is present.  
...
- 💻 **Source Code:** [github.com/TejasViswa/tracking-error-lab](https://github.com/TejasViswa/tracking-error-lab)
