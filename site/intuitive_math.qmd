...
::: {.callout-note}
**Assumptions:** This decomposition assumes zero-mean returns (or is written in deviation-from-mean form) and that portfolio weights and returns have sufficient independence properties. In practice, this provides useful intuition for understanding the sources of autocorrelation.
:::
